...
public class NeastedViewProfileAdapter extends RecyclerView.Adapter<NeastedViewProfileAdapter.ViewHolder> {
    ...
    List<com.entigrity.model.view_topics_of_interest.TagsItem> itemsInSection;
    LayoutInflater mInflater;


    public NeastedViewProfileAdapter(Context mContext, List<com.entigrity.model.view_topics_of_interest.TagsItem> mList) {
